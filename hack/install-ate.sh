...
usage() {
  ...
  echo ""
  echo "  --deploy-ate-system                    Deploy core system (CRDs, atelet, apiserver). Requires"
  echo "                                         BUCKET_NAME: the microvm SandboxConfig it applies names it."
  ...
  echo "                                         so BUCKET_NAME is still required and the bucket must be"
  echo "                                         populated some other way."
